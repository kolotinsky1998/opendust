...
if __name__ == "__main__":
    ...
    directory = "/home/avtimofeev/opendust/examples/IonConcentration/data_with_trap_from_file/"
    ...
    trapFileName = "/home/avtimofeev/opendust/examples/IonConcentration/data_with_trap/trapFile.txt"
    startEquilibrate = time.time()
    openDustEquilibrate.simulate(deviceIndex = "0", cutOff = False, considerTrap = True, trapFileName = trapFileName)
